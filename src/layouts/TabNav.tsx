      ...
      {TABS.map((tab, index) => (
        <Fragment key={tab.id}>
          ...
          <button
            ...
            className={cn(
              'inline-flex shrink-0 items-center gap-2 rounded-full px-4 py-1.5 text-sm font-medium whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400',
              activeTab === tab.id
